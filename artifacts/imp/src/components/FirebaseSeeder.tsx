...
export function FirebaseSeeder() {
    ...
    async function checkAndSeed() {
      ...
      try {
        ...
        if (patientsSnap.empty) {
          ...
          const drugs = [
            { name: 'Augmentin 625mg', scientificName: 'Amoxicillin/Clavulanate', category: 'Antibiotic', stock: 50, price: '4500 ر.ي', expiry: '2025-12-01', isNearingExpiry: false, brandNames: ['أموكسيدار', 'موكسيلين'] },
            { name: 'Panadol Advance', scientificName: 'Paracetamol', category: 'Analgesic', stock: 120, price: '1200 ر.ي', expiry: '2026-06-15', isNearingExpiry: false, brandNames: ['سيتامول', 'براسيتامول'] },
            { name: 'Lipitor 20mg', scientificName: 'Atorvastatin', category: 'Statins', stock: 30, price: '8900 ر.ي', expiry: '2025-09-20', isNearingExpiry: false, brandNames: ['ليبيتور'] }
          ];
          drugs.forEach(d => {
  ...
  if (complete) return <div className="fixed bottom-4 right-4 bg-emerald-500 text-white p-4 rounded-2xl shadow-2xl z-50 font-black">Database Seeded Successfully!</div>;
  return null;
}
