...
import { usePatients, Patient as PatientType } from '@/hooks/use-patients';

const initialPatients: PatientType[] = [
  { id: '1', fileNumber: 'P-1001', name: 'سناء علي عبد الله', phone: '777123456', email: 'sana@example.com', gender: 'أنثى', birthDate: '1996-05-01', status: 'active' },
  { id: '2', fileNumber: 'P-1002', name: 'محمد حسن صالح', phone: '770987654', email: 'mohammed@example.com', gender: 'ذكر', birthDate: '1979-04-28', status: 'active' },
  { id: '3', fileNumber: 'P-1003', name: 'ليلى مرشد السعدي', phone: '711223344', email: 'layla@example.com', gender: 'أنثى', birthDate: '1990-04-15', status: 'inactive' },
  { id: '4', fileNumber: 'P-1004', name: 'جابر يحيى حسين', phone: '733445566', email: 'jaber@example.com', gender: 'ذكر', birthDate: '1972-05-02', status: 'active' },
  { id: '5', fileNumber: 'P-1005', name: 'هند علي محمد', phone: '776655443', email: 'hind@example.com', gender: 'أنثى', birthDate: '2002-03-20', status: 'active' },
];
                ...
                {currentPatients.map((patient, i) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      ...
                      <span className="text-gray-500">{new Date().getFullYear() - new Date(patient.birthDate).getFullYear()} سنة</span>
                    </td>
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2 text-gray-600">
